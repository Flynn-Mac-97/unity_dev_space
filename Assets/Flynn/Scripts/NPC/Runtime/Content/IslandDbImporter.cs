...
{
    public static IEnumerator Import(IslandContent content, NpcMemoryDatabase db, IEmbeddingProvider embedder)
    {
    ...
    private static IEnumerator ImportKnowledge(NpcMemoryDatabase db, IEmbeddingProvider embedder,
    ...
    private static IEnumerator EmbedInto(IEmbeddingProvider embedder, string text, System.Action<float[]> set)
    {
