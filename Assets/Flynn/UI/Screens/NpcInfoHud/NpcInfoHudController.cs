...
namespace Flynn.UI.Screens.NpcInfoHud
{
    ...
    public class NpcInfoHudController : MonoBehaviour
    {
        ...
        private void ResolveChannel()
        {
            ...
            {
                var manager = SceneLlmManager.Instance;
        ...
        private void ApplyMemory(NpcContent npc)
        {
            ...
            int factCount = 0, turnCount = 0;
            string lastTurn = "";

            if (manager != null && manager.MemoryDb != null && manager.MemoryDb.IsOpen)
            {
