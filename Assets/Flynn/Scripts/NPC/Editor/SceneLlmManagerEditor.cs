...
public class SceneLlmManagerEditor : Editor
{
    ...
    private SerializedProperty _memoryStore;
    ...
    private void OnEnable()
    {
        ...
        _memoryStore               = serializedObject.FindProperty("memoryStore");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(_memoryStore);
        if (_memoryStore.objectReferenceValue == null)
            EditorGUILayout.HelpBox("Assign an NpcMemoryStore asset. Without it no chat history or long-term facts will persist between turns.", MessageType.Warning);
        ...
        if (_embeddingSettings.objectReferenceValue == null)
        {
            EditorGUILayout.HelpBox(
                ...
                "Without it, dialogue falls back to the keyword/chat-history path on the NpcMemoryStore.",
                MessageType.Info);
        }
        else
        {
